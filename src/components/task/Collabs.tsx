...
import agent301Img from "@/assets/agent301.jpg";
        ...
        <div className="mt-2">
            <div className="mb-4">
                <div className="flex items-center space-x-2">
                    <Image className="rounded-full w-8 h-8" src={goatsImg} alt="collabs logo" width={50} height={50} />
                    <p className="text-lg font-semibold text-white">GOATS</p>
                </div>
                ...
                <div className="border border-white/10 w-full mt-4"></div>
            </div>
            <div className="mb-4">
                <div className="flex items-center space-x-2">
                    <Image className="rounded-full w-8 h-8" src={agent301Img} alt="collabs logo" width={50} height={50} />
                    <p className="text-lg font-semibold text-white">Agent 301</p>
                </div>
                <div className="mt-2 rounded-full bg-white/10 p-2 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        <div className="bg-white/1 border-4 border-white/10 rounded-full p-2 text-gray-white">
